...
function StudentsListTable({ studentList }) {
  ...
  return (
    <div>
        <div className="p-2 ml-7 rounded-lg border shadow-sm flex gap-2 mb-4 max-w-sm">
            <Search />
            <input type="text" placeholder="Search anything...." className="outline-none w-full" onChange={(event)=> setSearchInput(event.target.value)}/>
        </div>
      <div
        className={theme == "dark" ? "ag-theme-quartz-dark px-7" : "ag-theme-quartz px-7"} // applying the Data Grid theme
